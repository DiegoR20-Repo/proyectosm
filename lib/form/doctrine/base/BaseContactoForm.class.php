...
abstract class BaseContactoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setWidgets(array(
      ...
      'pais'         => new sfWidgetFormChoice(array('choices' => array('COLOMBIA', 'ECUADOR', 'VENEZUELA', 'PERU', 'BRASIL'))),
      'departamento' => new sfWidgetFormChoice(array('choices' => $tsDepartamentos)),
      'municipio'    => new sfWidgetFormChoice(array('choices' => $tsCiudades)),
    ));
